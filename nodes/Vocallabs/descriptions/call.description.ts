...
export const callOperations: INodeProperties[] = [
    {
        ...
        options: [
            ...
            {
                name: 'Create Direct Call',
                value: 'createDirectCall',
                action: 'Create a direct call',
                description: 'Initiate a direct call to a phone number using a client token',
            },
            {
...
export const callFields: INodeProperties[] = [
    ...
    {
        displayName: 'Client Token ID',
        name: 'client_token_id',
        type: 'string',
        required: true,
        default: '',
        description: 'Your VocalLabs client token ID (get from Dashboard > Get Tokens)',
        displayOptions: {
            show: {
                resource: ['call'],
                operation: ['createDirectCall'],
            },
        },
    },
    {
        ...
        displayOptions: {
            show: {
                resource: ['call'],
                operation: ['createDirectCall', 'callAPI'],
            },
        },
    },
    {
